...
print('Case 1')
numpy_in = np.array(3.14, dtype=np.float32)
...
print('Case 5')
numpy_in = np.random.random((2, 3, 4)).astype(np.float32)
...
print('Case 6')
numpy_in = np.random.random((1, 3, 1)).astype(np.float32)
shape = np.array([2, 3, 4], dtype=np.int32)
...
print('Case 7')
numpy_in = np.random.random((1, 1, 1, 3)).astype(np.float32)
shape = np.array([2, 3, 4, 5, 3], dtype=np.int32)
...
print('Case 8')
numpy_in = np.random.random((2, 3, 4, 5)).astype(np.float32)
...
print('Case 9: Both sides 1')
numpy_in = np.array([[1]], dtype=np.float32)
shape = np.array([2,3], dtype=np.int32)
