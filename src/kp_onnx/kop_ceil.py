...
from pyshader.stdlib import ceil


@python2shader
def compute_shader_ceil(index=("input", "GlobalInvocationId", ivec2),
...
_ceil_code = compute_shader_ceil.to_spirv()
...
class CeilOp:
    ...
    def run(self, *inputs):
        ...
        algo = self.manager.algorithm([tensor_in, tensor_out], _ceil_code)
    ...
    def fuse(self, input_tensors: list[tuple[kp.Tensor, list[int]]], updated_algorithms: list[kp.Algorithm],
        ...
        updated_algorithms.append(self.manager.algorithm([tensor_in, tensor_out], _ceil_code))
