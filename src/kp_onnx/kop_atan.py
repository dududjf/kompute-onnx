...
from pyshader.stdlib import atan


@python2shader
def compute_shader_atan(index=("input", "GlobalInvocationId", ivec2),
...
_atan_code = compute_shader_atan.to_spirv()
...
class AtanOp:
    ...
    def run(self, *inputs):
        ...
        algo = self.manager.algorithm([tensor_in, tensor_out], _atan_code)
    ...
    def fuse(self, input_tensors: list[tuple[kp.Tensor, list[int]]], updated_algorithms: list[kp.Algorithm],
        ...
        updated_algorithms.append(self.manager.algorithm([tensor_in, tensor_out], _atan_code))
