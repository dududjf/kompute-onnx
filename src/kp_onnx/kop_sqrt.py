...
from pyshader.stdlib import sqrt


@python2shader
def compute_shader_sqrt(index=("input", "GlobalInvocationId", ivec2),
...
class SqrtOp:
    ...
    def run(self, *inputs):
        ...
        algo = self.manager.algorithm([tensor_in, tensor_out], _sqrt_code)
    ...
    def fuse(self, input_tensors: list[tuple[kp.Tensor, list[int]]], updated_algorithms: list[kp.Algorithm],
        ...
        updated_algorithms.append(self.manager.algorithm([tensor_in, tensor_out], _sqrt_code))
